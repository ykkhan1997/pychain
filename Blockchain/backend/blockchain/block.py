...
class Block:
    ...
    @staticmethod
    def from_json(block_json):
        '''Deserialize a block representation back into a block instance'''
        return Block(**block_json)
    ...
    def is_valid_block(last_block,block):
        ...
        -The blockhash must be a valid combination of the all blcok fields.
        A exception allow us to create our own error in python
        '''

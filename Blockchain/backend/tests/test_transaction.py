...
def test_reward_transaction():
    ...
    assert reward_transaction.input==MINING_REWARDS_INPUT
    assert reward_transaction.output[miner_wallet.address]==MINING_REWARDS
...
def test_valid_reward_transaction_extra_recipients():
    reward_transaction=Transaction.reward_transaction(Wallet())
...
def test_valid_reward_transaction_invalid_amount():
    ...
    reward_transaction=Transaction.reward_transaction(miner_wallet)
    reward_transaction.output[miner_wallet.address]=90001
